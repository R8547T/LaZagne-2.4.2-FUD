...
from r8547T.base.change_privileges import list_sids, rev2self, impersonate_sid_long_handle
from r8547T.base.users import get_user_list_on_filesystem, set_env_variables, get_username_winapi
from r8547T.base.dpapi_structure import SystemDpapi, are_masterkeys_retrieved
from r8547T.base.execute_cmd import save_hives, delete_hives
from r8547T.base.write_output import print_debug, StandardOutput
from r8547T.base.constant import constant
from r8547T.base.manage_modules import get_categories, get_modules
...
def run_r8547T(category_selected='all', subcategories={}, password=None):
