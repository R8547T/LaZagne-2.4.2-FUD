...
from r8547T.base.write_output import write_in_file, StandardOutput
from r8547T.base.manage_modules import get_categories
from r8547T.base.constant import constant
from r8547T.base.run import run_r8547T, create_module_dic
...
def runr8547T(category_selected='all', subcategories={}, password=None):
    """
    This function will be removed, still there for compatibility with other tools
    Everything is on the config/run.py file
    """
    for pwd_dic in run_r8547T(category_selected=category_selected, subcategories=subcategories, password=password):
        yield pwd_dic
...
if __name__ == '__main__':
    ...
    for r in runr8547T(category_selected=category, subcategories=subcategories, password=args.get('password', None)):
        pass
